...
//            Model model) {
//        List<FreePost> freePosts = postServiceOld.findAvailableFreePosts();
...
//        int size = postServiceOld.findAvailableFreePosts().size()/10 + 1;
//        List<FreePost> freePosts = postServiceOld.findAvailablePagingFreePosts(pageNum);
//        model.addAttribute("link", loginUser==null ? "login" : "freepost");
...
//        postServiceOld.savePost(freePost);
//
...
//        } //추가
//
//        postServiceOld.updatePost(postId, freePostDTO.getTitle(), freePostDTO.getContent());
//
