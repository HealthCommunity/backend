...
//import com.spa.springCommuProject.posts.domain.Video;
//import com.spa.springCommuProject.posts.domain.VideoPost;
//import com.spa.springCommuProject.posts.service.FileService;
//import com.spa.springCommuProject.posts.service.PostServiceOld;
//import com.spa.springCommuProject.posts.dto.VideoPostDTO;
...
//                               Model model) {
//        List<VideoPost> videoPosts = postServiceOld.findAvailableVideoPosts();
...
//        int size = postServiceOld.findAvailableVideoPosts().size()/10 + 1;
//        List<VideoPost> videoPosts = postServiceOld.findAvailablePagingVideoPosts(pageNum);
//        model.addAttribute("link", loginUser==null ? "login" : "videopost");
...
//
//        postServiceOld.viewIncrease(postId); //추가
//        Post post = postServiceOld.findOnePost(postId);
//
...
//        } //추가
//
//        postServiceOld.updatePost(postId, videoPostDTO.getTitle(), videoPostDTO.getContent());
//
...
//
//        postServiceOld.deletePost(postId);
//
