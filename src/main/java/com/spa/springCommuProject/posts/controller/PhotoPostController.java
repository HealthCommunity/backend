...
//import com.spa.springCommuProject.posts.dto.PhotoPostDTO;
...
//                               Model model) {
//        List<PhotoPost> photoPosts = postServiceOld.findAvailablePhotoPosts();
...
//        int size = postServiceOld.findAvailablePhotoPosts().size()/10 + 1;
//        List<PhotoPost> photoPosts = postServiceOld.findAvailablePagingPhotoPosts(pageNum);
//        model.addAttribute("link", loginUser==null ? "login" : "photopost");
...
//        } //추가
//
//        postServiceOld.updatePost(postId, photoPostDTO.getTitle(), photoPostDTO.getContent());
//
