...
//
//
//import com.spa.springCommuProject.posts.domain.*;
...
//    }
//
//    public List<Post> findAvailableAllFreePosts(){
//        return em.createQuery("select p from FreePost p where p.available = :available " +
//                        "and p.postCategory = :postCategory", Post.class)
//                .setParameter("available",true)
//                .setParameter("postCategory", PostCategory.FREEPOST);
//
//                //getResultList().stream().filter(x->x.getAvailable()==true).collect(Collectors.toList());
//    }
//
